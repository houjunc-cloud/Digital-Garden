...
We view the orbital integrals of $G$ and $H$ as linear functionals on $\Pi_{U_\theta, \psi}$ and $\Pi_{U_{\iota'},tr}$ both factoring through $\Pi_{U_\theta, \psi,U_{\iota'},tr}$
