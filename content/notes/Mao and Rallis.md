...
To fit in Venkatesh's principle, $G \times H$ acts on $\Tilde{M} = \mathcal O_{min}(G')$. $\Tilde{M} //_{Wh}H = V_{\rho} = M$ and $\Tilde{M}//_{Wh} G$. In addition to Venkatesh's principle, quanzation commutes with Whittaker reduction as well, so 