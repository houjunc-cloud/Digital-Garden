...
1. Compute $I = q^* \mathcal O$ and $J = q^* \mathcal O_1$ as a distribution/linear functional on $\Pi$ (minimal representation is Weil representation)
2. Because $q$ is surjective, $\mathcal O = \Delta_{\mathcal O} \mathcal O_1 \iff I = \Delta_{\mathcal O} J$
