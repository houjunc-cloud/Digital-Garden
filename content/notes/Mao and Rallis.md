...
2. For the explicit integral form of $I$, one-side group action on $\Phi \in \Pi$ can be computed explicitly by partial Fourier transform, scaling, translation. The other side group action somehow gives Fourier inversion.
