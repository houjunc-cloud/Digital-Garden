...
Proof: $T^*X = G \times ^H V$ where $V = \mathfrak h^\perp$. Let $\chi_X:V \to \mathfrak c_X$ be the quotient map, then $\mathfrak c_X = T^*X//G = V//H$  $W_X := T^*X//_{Wh}G \isom T^*X \times_{\mathfrak g^*} S_G$. 
