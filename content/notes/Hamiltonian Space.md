...
- For a reductive group $G$ and Hamiltonian space $M$, let $\mu: M \to \mathfrak g ^*$ be the moment map. Identify $\mathfrak g^* \isom \mathfrak g$ by the bilinear form, $\mathfra$