...
$X^L_\Theta$ has the same rank as $X$, and has spherical roots $\Theta$ and $Z(X_\Theta) = \Theta ^\perp \subset X^*(A_X)$. From the untwisted to the twisted case, besides $\Theta$ one has extra spherical roots from Whittaker induction $X^L_{\Theta, \psi}$
