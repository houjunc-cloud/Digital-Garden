...
$G_X$ has $2^{\Delta_X}$ -many relevant orbit families. To have orbit matching, we must compute all relevant orbits of $X$, and show relevant orbits of $X^L_{\alpha, \psi}$ match $$
