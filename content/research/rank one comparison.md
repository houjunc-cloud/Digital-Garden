...
To match this classification, the idea is to reduce to cuspidal rank one adjoint type first, then use some $p$-adic diffeomorphism to go back to $X$ (as CCL or Jacquet did for $SL_2 \times Z_{GL_2} \surj $) one first reduces to the adjoint type $X^L_\psi \surj X^L_\psi/Z(L)^0$,  
