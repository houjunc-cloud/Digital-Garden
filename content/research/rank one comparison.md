...
To match this classification, the idea is to reduce to cuspidal rank one adjoint type first, then use some  one first reduces to the adjoint type $X^L_\psi \surj X^L_\psi/Z(L)^0$,  
