...
To match this classification, the idea is to reduce to cuspidal rank one adjoint type first, then use some $p$-adic diffeomorphism to go back to $X$ (as CCL or Jacquet did for $SL_2 \times Z_{GL_2} \surj GL_2$ to separate the toric part and tangent part, hopefully)
