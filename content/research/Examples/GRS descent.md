It is (self dual) $\Delta = (SO_{4n}, Sp_{2n}, (2^{2n}), 0)$ with $\Delta_1 = (SO_{2n+1}, 1, \iota_{reg}, 0)$, and $M_{Sh,GL_{2n}}$ with $M_1 = M_{\Delta_1}$. And $Ind_P^G M_{Sh,GL_{2n}}^{\vee} = Ind_P^G = M_{Sh,SO_{4n}}$, where $P$ has Levi $GL_{2n}$
