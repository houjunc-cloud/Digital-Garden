...
The following explains the Bessel reduction step, i.e. a pre-step $M{/\!\!/}_{\lambda_B}U_B = M_1$. Finally $(M{/\!\!/}_{\lambda_B}U_B){/\!\!/}_{\lambda_{N_H}}N_H \isom M{/\!\!/}_{ \lambda_E} E = Wh_G = Wh_{G_X}$, where the second identity is by the root exchange lemma, $$ and $E \bijection (2n,2n)$ . 
