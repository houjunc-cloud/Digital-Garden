...
The following explains the Bessel reduction step on the geometric side, i.e. a pre-step $M{/\!\!/}_{\lambda_B}U_B = M_1$. Finally $(M{/\!\!/}_{\lambda_B}U_B){/\!\!/}_{\lambda_{N_H}}N_H \isom M{/\!\!/}_{ \lambda_E} E = Wh_G = Wh_{H}$, where the second identity is by the root exchange lemma, $H = G_X = SO_{2n+1}$ and $E \bijection (2n,2n)$ . 
