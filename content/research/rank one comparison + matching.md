...
2. There is one more improvement on 1, $M^\vee = (T^*G^\vee \times S_X)//G_X^\vee$, so we already have $M^\vee//G^\vee \isom S_X// G_X^\vee = M_1^\vee// G_X^\vee$. Applying Venkatesh's principle we have $M//_{Wh} G = M_1//_{Wh} G_X$
