...
>[!Proof Program]
>1. $\Phi$ is a symplectic isomorphism that identifies the relevant Lagrangians on both sides (this is wrong, a counterexample is G-J comparison with Hecke. But MWZ is still right; the comparison is by Fo).
