...
We try to relate $X//N$ to $X_1//N_{X} = Spec ~ k[X^*(A_X)^+]$. $\Lambda_{X_1}$ is the dominant weight lattice of $\Delta_X$ with dual cone $\Delta_X^\vee$, while $\Lambda_X$ is the dominant weight lattice of color valuations and $G$ - stable divisor valuations.
