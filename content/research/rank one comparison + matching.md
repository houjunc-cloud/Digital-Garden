...
>[!Expectation]
>Tranfer operator $T = H_1 \circ \Phi_* \circ H^{-1}$, where $H, H_1$ are Hankel transforms the two families of Lagrangian fibrations on $Wh_G$ and $Wh_{G_X}$ respectively. And $\$
