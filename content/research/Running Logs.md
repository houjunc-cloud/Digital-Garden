...
1. （S_X = 0）formulate清楚orbit matching，然后在这个框架下formluate rank one comparison，为什么toric quotient不影响，处理掉叠根情形（由sv保证，homogeneous的时候）。理论上能做quasi-affine X。
...
一个月过去了，基本没什么进展。Wh_G \to RTF base 未必是Lagrangian fibration，S_X \neq 0 还可能出现change of polarization。也许第一步要先把许多 $T^*X$ 上经典的结果推广到$T^*(X,\Psi)$。
